...
class enumratorBase(object):
    def __init__(self, base_url, engine_name, domain, subdomains=None, silent=False, verbose=True):
        ...
        # replaced User agent header below. Original header was:
...
def sublister_main(domain, threads, savefile, ports, silent, verbose, enable_bruteforce, engines):
    ...
    if engines is None:
        ...
        chosenEnums = [BaiduEnum, YahooEnum, GoogleEnum, BingEnum, AskEnum, Virustotal, ThreatCrowd, CrtSearch, PassiveDNS]
    else:
